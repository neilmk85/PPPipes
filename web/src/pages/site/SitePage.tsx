...
const CARDS: CardDef[] = [
  {
    ...
    gradient: 'linear-gradient(150deg, #3b1278 0%, #4c1d95 28%, #5b21b6 55%, #6422d0 78%, #6d28d9 100%)',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(150deg, #0c2461 0%, #1a3a8a 28%, #1e50b3 55%, #1d4ed8 78%, #3b82f6 100%)',
